  ...
  module SubscriptionAdapter
    class SolidMongoid < Base # :nodoc:
      ...
      def broadcast(channel, payload)
        ::SolidCableMongoid::Message.create!(channel: channel, message: payload.to_s, expiry: DateTime.now + SolidCableMongoid.expiration.seconds)
      end
